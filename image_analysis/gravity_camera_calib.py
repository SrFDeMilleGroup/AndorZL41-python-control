...
class gravityanalysis:
    def __init__(self, fname, gname, type):
        param = {"g": 9.8e-3, "confidence_band": 0.95} # g is gravitational acceleration in mm/ms^2

        time_sq, axial_position, axial_position_err, radial_position, radial_position_err = self.readhdf(fname, gname, param, type)
    ...
    def readhdf(self, fname, gname, param, type):
        with h5py.File(fname, "r") as f:
            ...
            for subg in group.keys():
                ...
                for img in image_list.keys():
                    ...
                    if type == "absrp":
                        roi = {"xmin":110, "xmax":170, "ymin":80, "ymax":150} # choose a braod roi for the first fit trial
                    elif type == "fluor":
...
filename = "images_20210818.hdf"
fname = filepath + filename
gname = "lambda_absrp_20210818_195208"
type = "absrp" # "absrp" or "fluor"
...
tof = gravityanalysis(fname, gname, type)
